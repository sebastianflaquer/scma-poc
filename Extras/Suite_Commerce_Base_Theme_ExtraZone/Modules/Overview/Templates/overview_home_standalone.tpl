<section class="overview-home-standalone">
  ...
  <div id="overview-home-standalone-banner" class="invoice-banner">
		<div data-cms-area="global_banner_overview-home-standalone-banner" data-cms-area-filters="global">
		</div>
	</div>
